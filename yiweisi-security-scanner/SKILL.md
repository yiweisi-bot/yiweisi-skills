...
| GitHub PAT | `github_pat_[A-Za-z0-9_]+` | `github_pat_xxxxxxxxxxxxx` |
| OpenAI API Key | `sk-[A-Za-z0-9]{48}` | `sk-xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx` |
| DeepSeek API Key | `sk-[A-Za-z0-9]{32}` | `sk-xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx` |
| 智谱 API Key | `[A-Za-z0-9]{32}\.[A-Za-z0-9]{16}` | `xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx.xxxxxxxxxxxxxxxx` |
| 豆包 API Key | `[A-Za-z0-9]{8}-[A-Za-z0-9]{4}-[A-Za-z0-9]{4}-[A-Za-z0-9]{4}-[A-Za-z0-9]{12}` | `xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx` |

### 2. 邮箱密码

| 类型 | 模式 | 示例 |
|------|------|------|
| 163 邮箱密码 | 包含 `163.com` + 密码 | `example@163.com` + `YourPassword123` |
| 通用密码 | `password[:=]\s*['"][A-Za-z0-9!@#$%^&*]+['"]` | `password: "YourPassword123"` |
